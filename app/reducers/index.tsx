...
import manageNewsReducer from 'containers/ManageNews/reducer'
import manageToolReducer from 'containers/ManageTool/reducer';
import manageBookReducer from 'containers/ManageBook/reducer';
...
export default function createReducer(injectedReducers = {}) {
  return combineReducers({
    ...
    manageTool: manageToolReducer,
    manageBook: manageBookReducer,
    ...injectedReducers,
  });
}
