...
export function getBookByIdAction(id: string) {
  return {
    type: GET_BOOK_BY_ID,
    id
  };
...
export function getBookDetailByIdAction(id: string) {
  return {
    type: GET_BOOK_DETAIL_BY_ID,
    id,
  };
}
...
export function assignBooksAction(books : object) {
  return {
    type: ASSIGN_BOOKS,
    books,
  };
...
export function setBookDetailAction(book: object) {
  return {
