...
import reducer from 'containers/ManageDinner/reducer';
import saga from 'containers/ManageDinner/saga';
...
function ManageDinner() {
  ...
  const onCreate = () => {
    ...
    loadInitialProduct();
    navigate('/manage-dinner/create');
  };

  const onEdit = (id: any) => {
    dispatch(setIdAction(id));
    onchangeFormMethod(PUT);
    navigate(`/manage-dinner/edit/${id}`);
  };
  ...
  return (
    <>
      ...
      <div className="manage-table">
        <DinnerTable onDelete={onDelete} onEdit={onEdit} />
      </div>
    </>
  );
}
export default ManageDinner;
