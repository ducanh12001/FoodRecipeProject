...
export const GET_AVATAR_REQUEST = 'containers/App/GET_AVATAR_REQUEST';
export const GET_AVATAR_SUCCESS = 'containers/App/GET_AVATAR_SUCCESS';
export const GET_AVATAR_ERROR = 'containers/App/GET_AVATAR_ERROR';
export const SEND_REDIRECT = 'containers/App/SEND_REDIRECT';
export const CLEAR_REDIRECT = 'containers/App/CLEAR_REDIRECT';